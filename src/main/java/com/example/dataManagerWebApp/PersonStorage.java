...
public class PersonStorage {
    ...
    public static void createSampleStorage() {
        ...
        Adress adress1 = new Adress("a1","Budapest", true);
        Adress adress2 = new Adress("a2", "Debrecen", false);
        Adress adress3 = new Adress("a3","Mezokovesd", true);
        Adress adress4 = new Adress("a4","Gyor", false);
